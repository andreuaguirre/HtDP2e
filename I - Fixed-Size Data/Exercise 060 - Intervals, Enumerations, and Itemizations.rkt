...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |Exercise 60 - Intervals, Enumerations, and Itemizations|) (read-case-sensitive #t) (teachpacks ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
;physical constants
...
(define (tl-render current-state)
  (cond
    [(= current-state 0)(place-image RB 10 7.5 TL)]
    [(= current-state 2)(place-image YB 25 7.5 TL)]
    [(= current-state 1)(place-image GB 40 7.5 TL)]))
