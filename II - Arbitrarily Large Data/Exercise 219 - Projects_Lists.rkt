...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname |Exercise 219 - Projects_Lists|) (read-case-sensitive #t) (teachpacks ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
; Physical Constants
...
; Posn -> Posn
; Consumes a Posn to create a new random one
...
; If the random posn equals to the last one, generates a recurssion
...
; Tail -> Boolean
; Determines if a Posn of Tail is repetead
...
; Worm -> Boolean
; Asks whether the worm has hit any border of the scene
...
; Worm Image -> Image
; Renders the score of a worm gamea
